...
export class CartService {
  ...
  // Subject will only send current messages/events to the subscriber after they are subscribed
  // totalPrice: Subject<number> = new Subject<number>();
  // totalQuantity: Subject<number> = new Subject<number>();

  // Behavior Subject will has the buffer of last event
  // Will receive the latest event prior to subscribing
